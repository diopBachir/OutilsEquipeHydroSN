...
mod_data4GR5Jmodel_ui <- function(id){
  ns <- NS(id)
  tagList(
    fluidRow(align="left",
             column(12,
...
#' data4GR5Jmodel Server Functions
#'
#' @noRd
mod_data4GR5Jmodel_server <- function(id){
...
# mod_data4GR5Jmodel_server("data4GR5Jmodel_1")
