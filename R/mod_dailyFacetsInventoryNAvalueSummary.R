#' dailyFacetsInventoryNAvalueSummary UI Function
#'
...
mod_dailyFacetsInventoryNAvalueSummary_ui <- function(id, label){
  ns <- NS(id)
  tagList(
...
#' dailyFacetsInventoryNAvalueSummary Server Functions
#'
#' @noRd
mod_dailyFacetsInventoryNAvalueSummary_server <- function(id, data){
...
# mod_dailyFacetsInventoryNAvalueSummary_server("dailyFacetsInventoryNAvalueSummary_1")
