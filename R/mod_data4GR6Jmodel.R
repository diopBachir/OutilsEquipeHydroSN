...
mod_data4GR6Jmodel_ui <- function(id){
  ns <- NS(id)
  tagList(
    fluidRow(align="left",
             column(12,
...
#' data4GR6Jmodel Server Functions
#'
#' @noRd
mod_data4GR6Jmodel_server <- function(id){
...
# mod_data4GR6Jmodel_server("data4GR6Jmodel_1")
