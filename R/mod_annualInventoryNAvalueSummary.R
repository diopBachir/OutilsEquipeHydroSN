#' annualInventoryNAvalueSummary UI Function
#'
...
mod_annualInventoryNAvalueSummary_ui <- function(id, label){
  ns <- NS(id)
  tagList(
...
#' annualInventoryNAvalueSummary Server Functions
#'
#' @noRd
mod_annualInventoryNAvalueSummary_server <- function(id, data){
...
# mod_annualInventoryNAvalueSummary_server("annualInventoryNAvalueSummary_1")
