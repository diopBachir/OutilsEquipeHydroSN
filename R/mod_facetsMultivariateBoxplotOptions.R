...
mod_facetsMultivariateBoxplotOptions_ui <- function(id){
  ...
  tagList(
    ...
    fluidRow(
      ...
      column(4, selectInput(ns("xAxisTextSize"), label = div("X-axis TextSize", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(5, 40, 1), 2), selected = 13)),
      column(4, selectInput(ns("yAxisTextSize"), label = div("Y-axis TextSize", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(5, 40, 1), 2), selected = 13)),
      ...
      column(4, selectInput(ns("threshold"), label = div("Seuil", style="family:Georgia;text-align:left;font-size:75%"),  choices = c("Oui"=TRUE, "Non"=FALSE), selected = FALSE)),
      ...
      column(4, selectInput(ns("thresholdSize"), label = div("Seuil LineSize", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(.2, 10, .01), 2), selected = .9)),
      ...
      column(4, selectInput(ns("legendNrow"), label = div("Leg. Nrow", style="family:Georgia;text-align:left;font-size:75%"),  choices = 1:10, selected = 1)),
      column(4, selectInput(ns("legendByRow"), label = div("Leg. Fill", style="family:Georgia;text-align:left;font-size:75%"),  choices = c("By Row" = TRUE, "By Column" = FALSE), selected = TRUE)),
      column(4, selectInput(ns("legendKeyWidth"), label = div("Leg. KeyWidth", style="family:Georgia;text-align:left;font-size:75%"),  choices = round(seq(.2, 10, .01), 2), selected = .80)),

      column(4, selectInput(ns("legendKeyHeight"), label = div("Leg. KeyHeight", style="family:Georgia;text-align:left;font-size:75%"),  choices = round(seq(.2, 10, .01), 2), selected = .8)),
      ...
      column(4, selectInput(ns("LegTextSize"), label = div("Leg. TextSize", style="family:Georgia;text-align:left;font-size:75%"),  choices = round(seq(5, 35, 1), 2), selected = 13)),

      column(4, selectInput(ns("LegTextColor"), label = div("Leg. TextColor", style="family:Georgia;text-align:left;font-size:75%"),  choices = colors(), selected = "black")),
      column(4, selectInput(ns("legTextMarginB"), label = div("Leg. TextMargB.", style="family:Georgia;text-align:left;font-size:70%"), choices = round(seq(-5, 5, .01), 2), selected = 0)),
      column(4, selectInput(ns("legTextMarginT"), label = div("Leg. TextMargT.", style="family:Georgia;text-align:left;font-size:70%"), choices = round(seq(-5, 5, .01), 2), selected = 0)),

      column(4, selectInput(ns("legTextMarginL"), label = div("Leg. TextMargL.", style="family:Georgia;text-align:left;font-size:70%"),  choices = round(seq(-5, 5, .01), 2), selected = 0)),
      column(4, selectInput(ns("legTextMarginR"), label = div("Leg. TextMargR.", style="family:Georgia;text-align:left;font-size:70%"), choices = round(seq(-5, 5, .01), 2), selected = 0)),
      column(4, selectInput(ns("legPosType"), label = div("Leg. Pos.Type", style="family:Georgia;text-align:left;font-size:75%"),  choices = c("Côté", "Coordonnées"), selected = "Côté")),

      column(4, selectInput(ns("legPosXcoord"), label = div("LegXaxisCoords", style="family:Georgia;text-align:left;font-size:75%"),  choices = round(seq(0, 1, .001), 3), selected = 0.500)),
      column(4, selectInput(ns("legPosYcoord"), label = div("LegYaxisCoords", style="family:Georgia;text-align:left;font-size:75%"),  choices = round(seq(0, 1, .001), 3), selected = 0.500)),
      column(4, selectInput(ns("legLoc"), label = div("Leg. Position", style="family:Georgia;text-align:left;font-size:75%"),  choices = c("top", "bottom", "left", "right"), selected = "bottom")),

      column(4, selectInput(ns("legMarginB"), label = div("Leg. Marg. B.", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(-5, 5, .01), 2), selected = 0)),
      column(4, selectInput(ns("legMarginT"), label = div("Leg. Marg. T.", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(-5, 5, .01), 2), selected = -.60)),
      column(4, selectInput(ns("legMarginL"), label = div("Leg. Marg. L.", style="family:Georgia;text-align:left;font-size:75%"),  choices = round(seq(-5, 5, .01), 2), selected = 0)),
      column(4, selectInput(ns("legMarginR"), label = div("Leg. Marg. R.", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(-5, 5, .01), 2), selected = 0)),

      # strips
      column(4, selectInput(ns("stripTextSize"), label = div("Strip TextSize", style="family:Georgia;text-align:left;font-size:75%"),  choices = round(seq(5, 35, 1), 2), selected = 13)),
      column(4, selectInput(ns("stripTextMarginB"), label = div("Strip Marg. B.", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(-5, 5, .01), 2), selected = 2)),
      column(4, selectInput(ns("stripTextMarginT"), label = div("Strip Marg. T.", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(-5, 5, .01), 2), selected = 0)),
      column(4, selectInput(ns("stripTextMarginL"), label = div("Strip Marg. L.", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(-5, 5, .01), 2), selected = 0)),
      column(4, selectInput(ns("stripTextMarginR"), label = div("Strip Marg. R.", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(-5, 5, .01), 2), selected = 0)),
      column(4, selectInput(ns("stripTextMarginUnit"), label = div("Strip Marg. Unit", style="family:Georgia;text-align:left;font-size:75%"), choices = c("pt", "cm"), selected = "pt")),

      column(4, selectInput(ns("panelYspacing"), label = div("panelYspacing", style="family:Georgia;text-align:left;font-size:75%"), choices =round(seq(-5, 5, .01), 2), selected = .5)),
      column(4, selectInput(ns("panelXspacing"), label = div("panelXspacing", style="family:Georgia;text-align:left;font-size:75%"), choices =round(seq(0, 5, .01), 2), selected = -.01)),
      ...
      column(4, selectInput(ns("FacetScale"), label = div("FacetScales", style="family:Georgia;text-align:left;font-size:75%"),  choices = c("fixed", "free_x", "free_y"), selected = "free_x")),
      column(4, selectInput(ns("reorderGprah"), label = div("Trier Graph", style="family:Georgia;text-align:left;font-size:75%"),  choices = c("Asc."="Descendant", "Desc."="Ascendant"), selected = "Ascendant")),

      column(12, textInput(ns("variableColors"), label = div("Couleur des Groupes", style="family:Georgia;text-align:left;font-size:85%"), value = "", placeholder = "red;green;blue;cyan;orange;...")),
