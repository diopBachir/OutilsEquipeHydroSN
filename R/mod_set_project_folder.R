#' set_project_folder UI Function
#'
...
mod_set_project_folder_ui <- function(id){
  ns <- NS(id)
  tagList(
...
#' set_project_folder Server Functions
#'
#' @noRd
mod_set_project_folder_server <- function(id){
...
# mod_set_project_folder_server("set_project_folder_1")
