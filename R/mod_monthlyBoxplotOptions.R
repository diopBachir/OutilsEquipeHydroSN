...
mod_monthlyBoxplotOptions_ui <- function(id){
  ...
  tagList(
    ...
    fluidRow(
      ...
      column(4, selectInput(ns("xAxisTextSize"), label = div("X-axis TextSize", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(5, 40, 1), 2), selected = 12)),
      column(4, selectInput(ns("yAxisTextSize"), label = div("Y-axis TextSize", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(5, 40, 1), 2), selected = 12)),
      ...
      column(4, selectInput(ns("xAxisTextAngle"), label = div("X-axis Angle", style="family:Georgia;text-align:left;font-size:75%"), choices = seq(0, 375, 5), selected = 90)),
      ...
      column(4, selectInput(ns("panelBackgroundLineSize"), label = div("Panel Size", style="family:Georgia;text-align:left;font-size:75%"),  choices = round(seq(.5, 7, .01), 2), selected = 1.75)),
      ...
      column(4, selectInput(ns("stripTextSize"), label = div("Strip TextSize", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(5, 40, 1), 2), selected = 13)),
      column(4, selectInput(ns("stripMarginBottom"), label = div("Strip MargB", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(-5, 5, .01), 2), selected = .20)),
      column(4, selectInput(ns("panelXspacing"), label = div("Panel X-space", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(-5, 5, .01), 2), selected = .10)),

      column(4, selectInput(ns("panelYspacing"), label = div("Panel Y-space", style="family:Georgia;text-align:left;font-size:75%"), choices = round(seq(-5, 5, .01), 2), selected = .25)),
      column(4, selectInput(ns("facetsNrow"), label = div("Facets N-row", style="family:Georgia;text-align:left;font-size:75%"), choices = 3:6, selected = 3)),
