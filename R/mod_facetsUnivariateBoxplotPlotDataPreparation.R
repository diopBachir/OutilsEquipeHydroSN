#' facetsUnivariateBoxplotPlotDataPreparation UI Function
#'
...
mod_facetsUnivariateBoxplotPlotDataPreparation_ui <- function(id){
  ns <- NS(id)
  tagList(
    ...
    fluidRow(align = "center",
             column(6, actionButtonStyled(ns("showData"), span("ReCharger", id=ns("showDataAnimate")), class= "", type="primary")),
...
#' facetsUnivariateBoxplotPlotDataPreparation Server Functions
#'
#' @noRd
mod_facetsUnivariateBoxplotPlotDataPreparation_server <- function(id, data){
  moduleServer( id, function(input, output, session){
    ...
    return(list(data_4_univariatefacets_boxplots = reactive({ result_recode() })))
...
# mod_facetsUnivariateBoxplotPlotDataPreparation_server("facetsUnivariateBoxplotPlotDataPreparation_1")
