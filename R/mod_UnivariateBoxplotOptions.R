...
mod_UnivariateBoxplotOptions_ui <- function(id){
  ...
  tagList(
    ...
    fluidRow(
      ...
      column(4, numericInput(ns("xAxisTextSize"), label = div("X-axis text size", style="family:Georgia;text-align:left;font-size:75%"), min=5, max=40, step=1, value = 12)),
      column(4, numericInput(ns("yAxisTextSize"), label = div("Y-axis text size", style="family:Georgia;text-align:left;font-size:75%"), min=5, max=40, step=1, value = 12)),
      ...
      column(4, numericInput(ns("xAxisTextHjust"), label = div("X-axis Hjust", style="family:Georgia;text-align:left;font-size:75%"),min=-5, max=5, step=.01, value = 1.00)),
      ...
      column(4, numericInput(ns("panelBackgroundLineSize"), label = div("Panel Size", style="family:Georgia;text-align:left;font-size:75%"), min=.5, max=7, step=.01, value = 2.7)),
