#' loading_bassin_outlet UI Function
#'
...
mod_loading_bassin_outlet_ui <- function(id){
  ns <- NS(id)
  tagList(
    fluidRow(align = "center",
             column(12,
                    shinyFiles::shinyFilesButton(
                      id = ns("vector_file"), label = "Exutoires [EPSG 4326]",
                      title = "Sélectionner Le Fichier Shapefile des Exutoires des Bassins Versants !",
...
#' loading_bassin_outlet Server Functions
#'
#' @noRd
mod_loading_bassin_outlet_server <- function(id, workingDirectory){
...
# mod_loading_bassin_outlet_server("loading_bassin_outlet_1")
