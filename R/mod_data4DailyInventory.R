#' data4DailyInventory UI Function
#'
...
mod_data4DailyInventory_ui <- function(id){
  ns <- NS(id)
  tagList(
...
#' data4DailyInventory Server Functions
#'
#' @noRd
mod_data4DailyInventory_server <- function(id){
  moduleServer( id, function(input, output, session){
    ...
    observeEvent(input$showDataset, {
      ...
      dataLoad(data_for_dailyInventoryGraph())
    ...
    observeEvent(input$showDatasetSummary, {
      ...
      stats_summary<-reactive({
        req(data_for_dailyInventoryGraph())
        naniar::miss_var_summary(data_for_dailyInventoryGraph()[,-1])  %>%
    ...
    return(
      list(
        data_for_dailyInventoryGraph = reactive({data_for_dailyInventoryGraph()}),
...
# mod_data4DailyInventory_server("data4DailyInventory_1")
